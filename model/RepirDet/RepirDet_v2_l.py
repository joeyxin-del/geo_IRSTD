...
class RepirDet(nn.Module):
    def __init__(self,arch = 's3' ,
        ...
        """
            hyper parameter
        """
        self.backbone_channels = [64*2, int(128*2.5), 256*3, 512*4]
        """"""
        self.backbone_channels_cat = [64*2 + 0, int(128*2.5) + 64, 256*3 + 64*4, 512*4 + 64*16]
        ...
        self.up2x = nn.Upsample(scale_factor=2,mode='nearest')
