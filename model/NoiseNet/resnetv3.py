...
class AttBlock(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        super(AttBlock, self).__init__(init_cfg=init_cfg)
...
class ResNet(BaseBackbone):
    ...
    arch_settings = {
        ...
        9: ((AttBlock,BasicBlock,BasicBlock,BasicBlock), (2, 2, 2, 2)),
