...
class NoiseNet(nn.Module):
    def __init__(self,):
        ...
        self.backbone = ResNet(depth=8,in_channels=1,stem_channels=32,base_channels=32,out_indices=(0,1,2,3))
    ...
    def forward(self, input):
        ...
        # print("feats8x: ",feats8x.shape)
        # print("feats16x: ",feats16x.shape)
        # print("feats32x: ",feats32x.shape)
